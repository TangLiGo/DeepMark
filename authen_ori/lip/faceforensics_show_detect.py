        ...
        if detect_flag:
            ...
            for index, face in enumerate(faces):
                ...
                for idx, point in enumerate(landmarks):
                    frame=cv2.circle(frame, (point[0, 0], point[0, 1]),2,(255, 0, 0),-1)
            output.write(frame)
...
#person_data=genFeatures('D:/TangLi/datasets/FaceForensics++/original_sequences/youtube\c23/videos/004.mp4')
#print(person_data)
genFeatures('D:/TangLi/datasets/FaceForensics++/original_sequences/youtube\c23/videos/169.mp4')
